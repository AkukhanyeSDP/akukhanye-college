...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:0a1e2b,100:c8963e&height=220&section=header&text=Akukhanye%20Private%20College&fontSize=42&fontColor=ffffff&animation=fadeIn&fontAlignY=38&desc=Proudly%20South%20African%20%C2%B7%20Est.%202010&descAlignY=58&descSize=18" width="100%"/>

<a href="https://AkukhanyeSDP.github.io/akukhanye-college/">
  <img src="https://readme-typing-svg.demolab.com/?font=Poppins&size=22&duration=3000&pause=1000&color=C8963E&center=true&vCenter=true&width=650&lines=Shaping+careers%2C+building+futures+since+2010;QCTO+%26+SETA+Accredited+%C2%B7+Mbizana%2C+Eastern+Cape;16%2B+Programmes+%C2%B7+NQF+Level+4%E2%80%935;5%2C200%2B+Graduates+%C2%B7+96%25+Pass+Rate" alt="Typing SVG" />
</a>

[![Website](https://img.shields.io/badge/Website-Live-brightgreen?style=for-the-badge&logo=googlechrome&logoColor=white)](https://AkukhanyeSDP.github.io/akukhanye-college/)
[![QCTO Accredited](https://img.shields.io/badge/QCTO-Accredited-0a1e2b?style=for-the-badge)](https://www.qcto.org.za/)
[![SETA Aligned](https://img.shields.io/badge/SETA-Aligned-c8963e?style=for-the-badge)](https://www.seta.org.za/)
[![NQF Certified](https://img.shields.io/badge/NQF-Certified-8a2be2?style=for-the-badge)](https://www.nqf.org.za/)
[![GitHub Pages](https://img.shields.io/badge/Hosted%20on-GitHub%20Pages-success?style=for-the-badge&logo=github)](https://pages.github.com/)

![Visitors](https://visitor-badge.laobi.icu/badge?page_id=AkukhanyeSDP.akukhanye-college)
![Last Commit](https://img.shields.io/github/last-commit/AkukhanyeSDP/akukhanye-college?style=flat-square&color=c8963e)
![Repo Size](https://img.shields.io/github/repo-size/AkukhanyeSDP/akukhanye-college?style=flat-square&color=0a1e2b)
...
<table>
<tr>
<td align="center"><img src="https://github.com/user-attachments/assets/b0c06bde-bc0a-419b-94e3-238e736a0a95" width="380"/><br/><sub>Campus &amp; college life</sub></td>
</tr>
<tr>
<td align="center">
<img src="https://github.com/user-attachments/assets/ff702354-1369-4189-b1ee-cb0549f90247" width="260"/>
<img src="https://github.com/user-attachments/assets/0eba1568-ea5d-405c-ba74-ba0124722b8a" width="260"/>
<br/><sub>Accreditation &amp; student milestones</sub></td>
</tr>
</table>
</div>

> Swap the `<sub>` captions above with whatever each photo actually shows (e.g. "Open Day 2026", "QCTO Certificate", "Graduation").
...
```mermaid
flowchart TD
    A[👤 Visitor] --> B{Entry Point}
    B --> C[index.html<br/>Landing Page]
    C --> D[Hero Section<br/>Animated Banner]
    C --> E[Programmes<br/>16+ Courses]
    C --> F[Accreditation<br/>QCTO · SETA · NQF]
    C --> G[Contact &amp; Location]
    C --> H[Admissions CTA]

    H --> I[Enquiry Form / WhatsApp / Phone]
    E --> J[(Programme Data)]

    subgraph SEO["🔍 SEO &amp; Discovery"]
        K[sitemap.xml]
        L[google-site-verification.html]
        M[Meta &amp; Open Graph Tags]
    end
    ...
    subgraph HOST["☁️ Hosting"]
        N[GitHub Pages]
        O[Custom Domain / Pages URL]
    end

    N --> C
    N --> O

    style A fill:#0a1e2b,color:#fff
    style C fill:#c8963e,color:#0a1e2b
    style HOST fill:#0a1e2b,color:#fff
    style SEO fill:#c8963e,color:#0a1e2b
```
...
classDiagram
    ...
    class Student {
        +String name
        +String programmeEnrolled
        +Boolean graduated
    }

    Website "1" --> "many" Programme : lists
    Programme "1" --> "1" Accreditation : certified by
    Website "1" --> "many" Student : recruits
    Student "many" --> "1" Programme : enrolled in
```
...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:c8963e,100:0a1e2b&height=100&section=footer" width="100%"/>
